...
########## Optimizer arguments
parser.add_argument('--max_time', type=float, default=48.0)
...
parser.add_argument('--maxIter', type=int, default=100000, help=' number of iterations for training')
...
args.dataset = datasets[args.pid]
args.nParticle = batch_sizes[args.pid]
args.alpha = alphas[args.pid]
rand_seed = 0
...
model.load_from("results/DS14/mcmc_vimco_10_0.001_psp_fixed_pop_fixed_rate_2025-01-18_04-46-57.pt")
...
test_lb, test_ELBO, test_kl_div, run_times, its = model.learn(args.alpha, maxiter=args.maxIter, max_time=args.max_time,
                                                              anneal_rate = 0.75, anneal_freq = 20000, test_freq = 1000,
                                                              n_particles=10, warm_start_interval=1,
